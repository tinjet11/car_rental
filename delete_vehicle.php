...
<h1> </h1> 
<?php $v_id = $_GET["v_id"] ?>
<form method="post"><h1>Would you like to delete this Vehicle ID:</h1><h1 style="color: wheat;"><?php echo $v_id; ?></h1><button name ="Delete"> Delete</button><button style="position:relative; bottom: 40px;right: 350px"><a href = "addeditdeletecars.php"> Back </a></button></form>

<?php
 $conn = new mysqli("localhost", "root", "", "car_details");
if (isset($_POST["Delete"])){
    if ($conn->query("DELETE FROM car_detail WHERE Vehicle_ID = '$v_id'") == TRUE){
